        ...
        async def webhook(request: Request) -> HTTPResponse:
            ...
            if content_type == "application/json":
                ...
                if self._is_interactive_message(payload):
                    ...
                    """
                        Implementation of slack quick-reply 
                    """

                    # calling quick_reply to replace the button
                    update_buttons = quick_reply.QuickReply()
                    update_buttons.updateMessage(payload)
